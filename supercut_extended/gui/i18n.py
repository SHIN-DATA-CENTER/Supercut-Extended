...
STRINGS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "out.method": "方式",
        "out.mode.encode": "GPU 再エンコード",
        "out.mode.encode.desc": "Outplayed と同じ方式。フレーム単位で正確",
    ...
    "en": {
        ...
        "out.method": "Method",
        "out.mode.encode": "GPU re-encode",
        "out.mode.encode.desc": "Same method as Outplayed, frame accurate",
