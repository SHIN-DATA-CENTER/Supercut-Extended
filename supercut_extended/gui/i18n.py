...
STRINGS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "frame.width": "幅",
        "frame.height": "高さ",
        "frame.crop": "黒帯のカット（px）",
        "frame.crop.left": "左",
        "frame.crop.right": "右",
        "frame.crop.top": "上",
        "frame.crop.bottom": "下",
        "frame.detect": "黒帯を自動検出",
        "frame.detecting": "検出中...",
        "frame.detected": "黒帯を検出しました（左{left} 右{right} 上{top} 下{bottom}）",
        "frame.detect_none": "黒帯は見つかりませんでした",
        "frame.detect_fail": "自動検出に失敗しました",
        "frame.detect_nomedia": "先に試合を選んでください",
        "frame.stretch": "画面いっぱいに引き延ばす",
        "frame.stretch.desc": "4:3 のゲーム画面が 16:9 の録画に入っているときなど、"
                             "黒帯をカットした映像を出力解像度いっぱいに広げます（縦横比は変わります）",
        "frame.stretched": " · 引き延ばし",
        "frame.note": "エンコード時間は出力解像度でほぼ決まります。"
                      "黒帯をカットすると画素が減るぶん少し速く、拡大すると遅くなります。",
        "frame.preview_source": "プレビューは出力される範囲だけを表示します。",
        ...
        "editor.close": "閉じる",
        "editor.clips": "クリップ",
        "editor.inspector": "インスペクタ",
        "editor.zoom": "拡大",
        "editor.fit": "全体表示",
        "editor.tool_select": "選択 (V)",
        "editor.tool_cut": "カット (C)",
        "editor.undo": "元に戻す",
        "editor.redo": "やり直す",
        "editor.duplicate": "複製",
    ...
    "en": {
        ...
        "frame.width": "Width",
        "frame.height": "Height",
        "frame.crop": "Crop black bars (px)",
        "frame.crop.left": "Left",
        "frame.crop.right": "Right",
        "frame.crop.top": "Top",
        "frame.crop.bottom": "Bottom",
        "frame.detect": "Detect black bars",
        "frame.detecting": "Detecting...",
        "frame.detected": "Found black bars (left {left}, right {right}, "
                          "top {top}, bottom {bottom})",
        "frame.detect_none": "No black bars found",
        "frame.detect_fail": "Detection failed",
        "frame.detect_nomedia": "Select a match first",
        "frame.stretch": "Stretch to fill the frame",
        "frame.stretch.desc": "For a 4:3 game recorded inside a 16:9 capture: widen the "
                              "cropped picture to fill the output (aspect ratio changes)",
        "frame.stretched": " - stretched",
        "frame.note": "Render time follows the output resolution: cropping bars away is "
                      "slightly faster, upscaling is slower.",
        "frame.preview_source": "The preview shows only what will be written out.",
        ...
        "editor.zoom": "Zoom",
        "editor.fit": "Fit",
        "editor.tool_select": "Select (V)",
        "editor.tool_cut": "Razor (C)",
        "editor.undo": "Undo",
        "editor.redo": "Redo",
